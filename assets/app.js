const translations = {
  en: {
    heading: "Asmetry",
    subtitle:
      "To prevent bot spam and verify that you are a real user, please complete a survey from the survey list below. Once completed, the app will be instantly unlocked and downloaded to your mobile phone.",
    ...
    footer: "© 2026 Asmetry. Built with honest offers, by design.",
  ...
  fr: {
    heading: "Asmetry",
    subtitle:
      "Pour éviter les spam de robots et vérifier que vous êtes un utilisateur réel, veuillez complétez un sondage depuis la liste ci-dessous. Une fois terminé, l'application sera immédiatement téléchargée dans votre appareil mobile.",
    ...
    footer: "© 2026 Asmetry. Conçu avec des offres honnêtes.",
